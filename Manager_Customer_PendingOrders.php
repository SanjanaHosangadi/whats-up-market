    ...
    <a href="Manager_Product_View.php" class="list-group-item"><h4>Products</h4></a>
     ...
     <div class="col-md-9 container">
	   ...
	   <div class="tab-content">
							...
							<form action="ordercustomer.php" method="post" onsubmit='return validate()'>
								<input type="radio" id="name" name="customer_order" value="1" checked> Name of the customer</input> </br>
								<input type="radio" id="ID" name="customer_order" value="2"> ID of the customer</input> <br/> <br/>
