...
<head>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
	...
	<script src='validatecsearch.js' type='text/javascript'> </script>
   ...
   <div class="container-fluid">
    ...
    <a href="Manager_Product_View.php" class="list-group-item"><h4>Products</h4></a>
      ...
      <div class="tab-content">
							...
							<form action="searchcustomer.php" method="post" onsubmit="return validate()">
								<input type="radio" id="name" name="customer_search" value="1" checked> Name of the customer</input> </br>
								<input type="radio" id="ID" name="customer_search" value="2"> ID of the customer</input> <br/> <br/>
